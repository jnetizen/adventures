...
const familyExclusiveAdventures: Record<string, string[]> = {
  'candy-volcano': ['jenny-family'],
  'dragon-knight-rescue': ['jenny-family'],
  'fire-gem-quest': ['jenny-family'],
  'race-to-rainbow-reef': ['jenny-family'],
  'frozen-volcano': ['jenny-family'],
  'shadow-knight-lost-grove': ['jenny-family'],
  'rainbow-bridge': ['jenny-family'],
  'ancient-shrine': ['jenny-family'],
  'wizards-library': ['jenny-family'],
  'sparkle-lost-star': ['jenny-family'],
  'grizzy-lemmings-heist': ['jenny-family'],
